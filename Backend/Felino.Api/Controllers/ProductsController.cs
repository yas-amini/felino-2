        ...
        public IActionResult GetProducts()
        {
            var products = new[]
            {
                new { 
                    ...
                    name = "Margherita", 
                    category = "pizza", 
                    ingredients = new[] { "Tomatsås", "Färsk Mozzarella", "Färsk Basilika" }, 
                    price = 105, 
                ...
                new { 
                    ...
                    name = "Vesuvius", 
                    category = "pizza", 
                    ingredients = new[] { "Tomatsås", "Mozzarella", "Skinka" }, 
                    price = 115, 
                ...
                new { 
                    ...
                    name = "Capricciosa", 
                    category = "pizza", 
                    ingredients = new[] { "Tomatsås", "Mozzarella", "Skinka", "Champinjoner" }, 
                    price = 120, 
                ...
                new { 
                    ...
                    name = "Kebabpizza", 
                    category = "pizza", 
                    ingredients = new[] { "Tomatsås", "Mozzarella", "Kebabkött", "Feferoni", "Vitlökssås" }, 
                    price = 130, 
